                    ...
                    Stack(
                      ...
                      children: [
                        ...
                        if (showCurrentTimeIndicator)
                          Positioned(
                            top: (DateTime.now().minute / 60.0) * 60.0,
                            child: Container(
                              width: 10,
                              height: 10,
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  border: Border(
                                    bottom: BorderSide(
                                      color: isDark
                                          ? const Color(0xFF424754).withValues(alpha: 0.1)
                                          : Colors.grey[200]!,
                                    ),
                                  ),
                                ),
            ...
            if (task.category.isNotEmpty) ...[
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(fontSize: 8, fontWeight: FontWeight.bold, color: blockTextColor),
                ),
              ),
            ]
          ],
