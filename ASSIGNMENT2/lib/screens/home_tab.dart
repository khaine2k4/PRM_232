...
class _HomeTabState extends State<HomeTab> {
            ...
            children: [
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Padding(
                      ...
                      child: ChoiceChip(
                        ...
                        selected: isSelected,
                        onSelected: (selected) {
                          if (selected) setState(() => _categoryFilter = catName);
                        },
              ...
              if (filtered.isEmpty)
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) => _buildTaskCard(filtered[index], isDark),
                ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      completionPercentage == 1.0 && totalTasks > 0
  ...
  Widget _buildTaskCard(TodoTask task, bool isDark) {
    ...
    final formattedTime =
        task.dueDate != null ? DateFormat('hh:mm a').format(task.dueDate!) : 'Hôm nay';
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: task.isCompleted
                            ? AppTheme.completed
                            : (isDark ? const Color(0xFF424754) : Colors.grey[400]!),
                        width: 2,
                      ),
                    ),
                      ...
                      Row(
                        children: [
                          Icon(Icons.schedule_rounded,
                              size: 13, color: isDark ? const Color(0xFF8C919E) : Colors.grey),
